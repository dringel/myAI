...
export const INITIAL_MESSAGE: string = "Hello, I'm ${AI_NAME}, ${OWNER_NAME}'s AI assistant. Let me know if you have any question about investment banking recruiting";
